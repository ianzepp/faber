 ...
 *
 * Steps:
 *   1. Generate norma.gen.ts from fons/norma/index.json (TS-only extract)
 *   2. Compile faber CLI to standalone binary
 */
...
async function main() {
    ...
    // Generate TS-only norma registry
    await generateNormaTs();
