 ...
 *
 * USAGE
 *   bun run tests/proba/harness/runner.ts                    Run all tests
 *   bun run tests/proba/harness/runner.ts --verify           Run with verification
 *   bun run tests/proba/harness/runner.ts --db path/to.db    Custom database path
 *   bun run tests/proba/harness/runner.ts --compiler faber   Compiler (faber|rivus)
 *   bun run tests/proba/harness/runner.ts --feature si       Filter by feature
 *
 * OUTPUT
